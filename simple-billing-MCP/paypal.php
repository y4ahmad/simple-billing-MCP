	...
	{		
		...
		if( !empty( $orders ) )
		{
			...
			else
			{
				...
				$p->add_field('return', $this_script.'?m=simple-billing-MCP&p=paid');
				$p->add_field('cancel_return', $this_script.'?m=simple-billing-MCP&p=cart');
				$p->add_field('notify_url', $current_folder_url.'modules/simple-billing-MCP/paid-ipn.php');
