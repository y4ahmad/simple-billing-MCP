...
$install_queries[0] = array(
	...
	`price_weekly` float(15,4) NOT NULL,
	`price_monthly` float(15,4) NOT NULL,
	`price_quarterly` float(15,4) NOT NULL,
	`price_year` float(15,4) NOT NULL,
	`RAM_Allocation` int(11) NOT NULL,
	...
	`location` varchar(20),
	`RAM_Allocation` varchar(16),
	`CPU_Priority` varchar(16),
	`VIP_Ticket` varchar(16),
